...
class classification(object):
    ...
    def createClassificationTable(self, connection):
    ...
    def getStudentInfo(self, connection):
    ...
    def selectClassificationByID(self, connection, student_id):
    ...
    def UpdateClassification(self, connection):
    ...
    def GetCreditsAmount(self, connection):
